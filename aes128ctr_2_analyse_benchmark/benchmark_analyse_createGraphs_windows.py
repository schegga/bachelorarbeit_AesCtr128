...
# Daten einlesen
data = pd.read_excel('benchmark_messdaten_windows.xlsx')
...
plt.title('CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
...
path_to_save = 'graphen/windows/0_overall_vergleich_logarithmisch.svg'
...
# Graph als svg speichern
path_to_save = 'graphen/windows/1_parallel_vergleich_logarithmisch.svg'
plt.savefig(path_to_save)
...
plt.title('Verschlüsselungszeiten 1 KB - CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
...
path_to_save_bar = 'graphen/windows/1KB_balkendiagramm.svg'
...
# Achsentitel und Legende hinzufügen
plt.title('Verschlüsselungszeiten 10 KB - CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
plt.xlabel('Implementierung / Anzahl der Threads', fontsize=fontsize_label)
plt.ylabel('Verschlüsselungszeit [ms]', fontsize=fontsize_label)
plt.xticks(fontsize=fontsize_ticks)
plt.yticks(fontsize=fontsize_ticks)
...
# Diagramm als svg speichern
path_to_save_bar = 'graphen/windows/10KB_balkendiagramm.svg'
plt.savefig(path_to_save_bar)
...
# Achsentitel und Legende hinzufügen
plt.title('Verschlüsselungszeiten 100 KB - CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
plt.xlabel('Implementierung / Anzahl der Threads', fontsize=fontsize_label)
plt.ylabel('Verschlüsselungszeit [ms]', fontsize=fontsize_label)
plt.xticks(fontsize=fontsize_ticks)
plt.yticks(fontsize=fontsize_ticks)
...
# Diagramm als svg speichern
path_to_save_bar = 'graphen/windows/100KB_balkendiagramm.svg'
plt.savefig(path_to_save_bar)
...
# Achsentitel und Legende hinzufügen
plt.title('Verschlüsselungszeiten 1.000 KB - CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
plt.xlabel('Implementierung / Anzahl der Threads', fontsize=fontsize_label)
plt.ylabel('Verschlüsselungszeit [ms]', fontsize=fontsize_label)
plt.xticks(fontsize=fontsize_ticks)
plt.yticks(fontsize=fontsize_ticks)
...
# Diagramm als svg speichern
path_to_save_bar = 'graphen/windows/1000KB_balkendiagramm.svg'
plt.savefig(path_to_save_bar)
...
# Achsentitel und Legende hinzufügen
plt.title('Verschlüsselungszeiten 10.000 KB - CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
plt.xlabel('Implementierung / Anzahl der Threads', fontsize=fontsize_label)
plt.ylabel('Verschlüsselungszeit [ms]', fontsize=fontsize_label)
plt.xticks(fontsize=fontsize_ticks)
plt.yticks(fontsize=fontsize_ticks)
...
# Diagramm als svg speichern
path_to_save_bar = 'graphen/windows/10000KB_balkendiagramm.svg'
plt.savefig(path_to_save_bar)
...
# Achsentitel und Legende hinzufügen
plt.title('Verschlüsselungszeiten 100.000 KB - CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
plt.xlabel('Implementierung / Anzahl der Threads', fontsize=fontsize_label)
plt.ylabel('Verschlüsselungszeit [ms]', fontsize=fontsize_label)
plt.xticks(fontsize=fontsize_ticks)
plt.yticks(fontsize=fontsize_ticks)
...
# Diagramm als svg speichern
path_to_save_bar = 'graphen/windows/100000KB_balkendiagramm.svg'
plt.savefig(path_to_save_bar)
...
# Achsentitel und Legende hinzufügen
plt.title('Verschlüsselungszeiten 1.000.000 KB - CPU: AMD Ryzen 5 4600H', fontsize=fontsize_title)
plt.xlabel('Implementierung / Anzahl der Threads', fontsize=fontsize_label)
plt.ylabel('Verschlüsselungszeit [ms]', fontsize=fontsize_label)
plt.xticks(fontsize=fontsize_ticks)
plt.yticks(fontsize=fontsize_ticks)
...
# Diagramm als svg speichern
path_to_save_bar = 'graphen/windows/1000000KB_balkendiagramm.svg'
plt.savefig(path_to_save_bar)

# ---------- 7 graphen/windows nebeneinander vergleich ----------
...
path_to_save_bar = 'graphen/windows/combined_balkendiagramm.svg'
plt.savefig(path_to_save_bar)
